...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const handleMouseDown = (e: MouseEvent) => {
      ...
      const { x, y } = getLocalPosition(e.clientX, e.clientY);
    ...
    const handleTouchStart = (e: TouchEvent) => {
      ...
      for (let i = 0; i < touches.length; i++) {
        const { x, y } = getLocalPosition(touches[i].clientX, touches[i].clientY);
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 z-50 w-full h-full pointer-events-auto">
